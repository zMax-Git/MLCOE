...
LastEditTime: 2026-01-11 19:33:50
...
def augmented_ukf_sv(y, alpha_sv, sigma_sv, beta_sv,
    ...
    X_n = alpha_sv * X_{n-1} + sigma_sv * V_n
    log(Y_n) = log(beta^2) + X_n + log(W_n^2)
    """
    T = len(y)
    # storage
    m_filt = np.zeros(T)
...
if __name__ == "__main__":
    ...
    plt.savefig('uncent-kalman-2.png', dpi=300, bbox_inches='tight')
    plt.show()
